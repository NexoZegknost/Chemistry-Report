...
Gọi \(\mathcal{K}\) là bậc tổng cộng của phản ứng. Khi đó:
\begin{equation}
    \boxed{\mathcal{K} = \mathcal{M} + \mathcal{N} = 1{,}190 + 0{,}190 = 1{,}380}
\end{equation}
...
\begin{enumerate}
    \item \textbf{Trong thí nghiệm trên, nồng độ của \ce{Na2S2O3} và \ce{H2SO4} ảnh hưởng thế nào đến vận tốc phản ứng? Viết biểu thức vận tốc và xác định \mbox{bậc phản ứng.}}
        ...
        \begin{equation}
            \mathcal{M} = 1,190, \qquad \mathcal{N} = 0,190, \qquad \mathcal{K} = \mathcal{M} + \mathcal{N} = 1,380
        \end{equation}
